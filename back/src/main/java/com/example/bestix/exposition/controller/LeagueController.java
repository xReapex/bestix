...
public class LeagueController {
    ...
    public ResponseEntity createLeague(@PathVariable("leagueName") String leagueName,
            @PathVariable("nbPlayers") int nbPlayers, @PathVariable("champ") int champ,
    ...
    public boolean requestLeagueAccess(@PathVariable("leagueId") int leagueId,
